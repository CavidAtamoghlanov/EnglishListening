...
import type { GrammarModeConfig } from "../config/modes";
...
type GrammarModeCardProps = {
  config: GrammarModeConfig;
  onStart: () => void;
};

export function GrammarModeCard({ config, onStart }: GrammarModeCardProps) {
