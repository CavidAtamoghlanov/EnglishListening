...
export function WritingFeedback({ tone, message, explanation, correctAnswer }: WritingFeedbackProps) {
    ...
    <View style={[styles.panel, isCorrect && styles.correct, isWrong && styles.wrong]}>
      ...
      <View style={styles.copy}>
        <AppText style={styles.message}>
          {message ?? "Write the English answer, then check it."}
        </AppText>
        {correctAnswer && tone !== "neutral" ? (
          <AppText style={styles.answer}>Correct answer: {correctAnswer}</AppText>
        ) : null}
