...
import type { WritingLevelConfig } from "../config/levels";
import { colors } from "../../../theme/colors";
import { radii } from "../../../theme/radii";
import { spacing } from "../../../theme/spacing";

type WritingLevelCardProps = {
...
export function WritingLevelCard({
  ...
  onStart,
  onRestart,
}: WritingLevelCardProps) {
  return (
    <AppCard padding="lg" style={selected ? [styles.card, styles.cardSelected] : styles.card}>
